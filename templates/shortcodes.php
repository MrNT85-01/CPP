...
<div class="wrap">
    ...
    <p><?php _e('این شورت‌کد محصولات را در یک نمای گرافیکی شبیه به تصویر نمونه، همراه با دکمه‌های فیلتر بر اساس دسته‌بندی نمایش می‌دهد. این نما شامل ستون «آخرین بروزرسانی» برای هر محصول است.', 'cpp-full'); ?></p>
    <div class="cpp-shortcode-example">
    ...
    <p><?php _e('این شورت‌کد نیز محصولات را در نمای گرید نمایش می‌دهد، اما ستون «آخرین بروزرسانی» را ندارد. به جای آن، تاریخ و ساعت جدیدترین بروزرسانی در کل محصولات را در بالای جدول نمایش می‌دهد.', 'cpp-full'); ?></p>
    <div class="cpp-shortcode-example">
