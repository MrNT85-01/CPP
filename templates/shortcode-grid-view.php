...
// --- شروع تغییر: خواندن تنظیمات نمایش تصویر ---
$show_image = get_option('cpp_grid_show_image', 0);
// --- پایان تغییر ---
?>

<div class="cpp-grid-view-wrapper" id="cpp-grid-with-date">
    ...
    <table class="cpp-grid-view-table">
        <thead>
            <tr>
                <?php if ($show_image) : ?><th><?php _e('تصویر', 'cpp-full'); ?></th><?php endif; ?>
        ...
        <tbody>
            <?php if (!empty($products)) : foreach ($products as $product) : ?>
                <tr class="product-row" data-cat-id="<?php echo esc_attr($product->cat_id); ?>">
                    ...
                    <td class="col-price"><?php echo esc_html(number_format((float)str_replace(',', '', $product->price))); ?></td>
                    <?php endif; ?>
