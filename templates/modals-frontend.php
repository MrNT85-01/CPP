...
<div id="cpp-order-modal" class="cpp-modal-overlay" style="display:none;">
    <div class="cpp-modal-container">
        ...
        <h3><?php _e('ثبت سفارش برای:', 'cpp-full'); ?> <span class="cpp-modal-product-name"></span></h3>
        <form id="cpp-order-form">
            ...
            <div class="cpp-form-field">
                <label for="qty"><?php _e('مقدار/تعداد درخواستی', 'cpp-full'); ?> <span class="required">*</span></label>
            ...
            <div class="cpp-form-field cpp-captcha-field">
                 ...
                 <div class="cpp-captcha-wrap">
                     ...
                     <input type="text" name="captcha_input" id="captcha_input" required maxlength="4" class="ltr" style="direction:ltr; text-align:center;">
                 </div>
                 <style>
                    .cpp-captcha-wrap { display: flex; align-items: center; gap: 10px; }
                    .cpp-captcha-code {
                        ...
                        min-width: 80px; /* Ensure space for 4 digits */
                        text-align: center;
                    }
                    ...
                    #captcha_input { width: 100px !important; flex-grow: 0; } /* Adjust input width */
                 </style>
            </div>
            <div class="cpp-form-field">
